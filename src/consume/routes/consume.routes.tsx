...
const _consumeRoutes = [
  ...
  { component: Study },
  {
    render: (props: RouteProps) => (
      <StudySummarize
        {...props}
        message="SSummarize everything you've learned during this study block. Try to do it from memory, without looking at the material."
      />
    ),
  },
...
export const CONSUME_STUDY_PAGE_NUMBER =
  _consumeRoutes.findIndex((route) => route.component === Study) + 1;
